...
public class MusicWidget4x2 extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager,
        ...
        for (int appWidgetId1 : appWidgetIds) {
            try {
                ...
                views.setTextViewText(R.id.artistTextView, MusicPlayback.mMediaSessionCompat.getController().getMetadata().getString(MediaMetadataCompat.METADATA_KEY_ARTIST));
